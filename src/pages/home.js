...
export default function Home() {
    ...
    const handleBlur = () => {
        setTimeout(() => {
            setDisplayValue("none")
        }, 180) // the timeout is here so that user has enough time to click on the options before it loses focus
    }
        ...
        setPlayers((prevPlayers) => {
            return [
                ...prevPlayers, {
                    ...
                    elements_type: player.element_type === 1 ? "GK" : player.element_type === 2 ? "DF" : player.element_type === 3 ? "MD" : player.element_type === 4 ? "FW" : "unknown",
    ...
    if (loading || chartDataLoading) {
        ...
        return (
            <div className="App">
                ...
                {
                (players.length !== 0) && <SearchDisplay handleClick={handleClick}
                ...
                <div className='flex-row'>
                    <div> {
                        (players.length !== 0) && <Card animate={animate}
                            player={
                                players[0]
                            }/>
                    }
                            ...
                            <table className='table'>
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <button className='btn'
                                                onClick={refreshButton}>Refresh Cache</button>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
